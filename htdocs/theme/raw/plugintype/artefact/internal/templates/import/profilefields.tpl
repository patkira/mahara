...
<fieldset id="{$profilegroup.id}_fs" class="pieform-fieldset collapsible {if $dwoo.foreach.profilegroup.last} last{/if}">
    <legend>
        <h4>
    ...
    {foreach from=$profilegroup.fields key=fieldname item=fieldvalues}
        ...
        <div id="profilefield-{$profilegroup.id}" class="list-group-item">
